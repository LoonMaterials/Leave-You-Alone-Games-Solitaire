(function () {
  "use strict";
  try {
    localStorage.setItem("leave-me-alone-games-last-game", JSON.stringify({ id: "spider", href: "games/spider/index.html", title: document.querySelector("h1")?.textContent?.trim() || "spider", playedAt: Date.now() }));
  } catch {}
